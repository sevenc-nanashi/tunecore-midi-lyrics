...
> [!TIP]
> また、ニコニコ動画の歌詞登録ページで使うSRTファイルをMIDIファイルから生成することもできます：  
> <https://sevenc7c.com/tunecore-midi-lyrics/>
...
MIDI内のタイミングを早めます。
例えば、2秒に設定すると、MIDI内の2秒が0秒として扱われます。
音源の最初の無音を削った時など、音源のタイミングとMIDIのタイミングがずれている場合に調整するために使用します。
負の値に設定すると、MIDI内のタイミングを遅らせることができます。
